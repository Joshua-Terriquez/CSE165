...
MainWindow::MainWindow(QWidget *parent)
    : QOpenGLWindow()
{
    //VIDEO 1 added these Methods for the creating of our window
    /*
     ...
     * VIDEO 2 FOR FIXED FUNCTION PIPELINE AND WE'RE TELLING QT
     */
...
{
    // VIDEO 2 ADDED GLCLEARCOLOR AND GLCLEAR AND GLFLUSH
